// Chat Widget Script - Bubbly Design - Complete Fixed Version
(function() {
    ...
    async function sendMessage(message) {
        ...
        try {
            ...
            if (typeof data === 'string') {
                ...
                botResponse = firstItem?.message || firstItem?.output || firstItem?.text || JSON.stringify(firstItem);
            } else if (typeof data === 'object') {
                botResponse = data.message || data.output || data.text || data.response || data.result || JSON.stringify(data);
            }
            ...
            errorMessageDiv.textContent = 'عذراً، حدث خطأ في الاتصال. الرجاء المحاولة مرة أخرى.';
