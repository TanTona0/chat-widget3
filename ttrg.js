// Chat Widget Script - Bubbly Design with Persistent History & RTL Support
(function() {
    ...
    const chatHTML = `
        <div class="brand-header">
            ...
            <button class="clear-chat-button" title="مسح المحادثة">
    ...
    const clearChatBtn = chatContainer.querySelector('.clear-chat-button');
    ...
    function startNewConversation() {
        ...
        if (!currentSessionId) {
            ...
            const welcomeMessage = {
                text: config.branding.welcomeText,
                type: 'bot'
            };
            addMessageToUI(welcomeMessage.text, welcomeMessage.type);
    ...
    async function sendMessage(message) {
        ...
        addMessageToUI(userMessage.text, userMessage.type);
        ...
        try {
            ...
            addMessageToUI(botMessage.text, botMessage.type);
            ...
            const errorMessage = {
                text: 'Error: Could not send message. Check console for details.',
                type: 'bot'
            };
            addMessageToUI(errorMessage.text, errorMessage.type);
