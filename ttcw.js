...
<body>
    <div class="demo-content">
        ...
        <p>The chat widget should appear in the bottom right corner. Click it to open the chat.</p>
        <p><strong>Note:</strong> Configure your webhook URL in the script below to enable actual message sending.</p>
    </div>
    ...
    <script>
        ...
        window.ChatWidgetConfig = {
            webhook: {
                url: 'https://your-webhook-url.com/webhook', // CHANGE THIS to your actual webhook URL
                route: ''
            },
            branding: {
