// Enhanced Chat Widget Script - Complete Working Version
(function() {
    'use strict';
    ...
    // Safe UUID generator with fallback for non-secure/old browsers.[web:1][web:20]
    ...
    // Always ensure a session ID exists when starting a conversation.
    ...
    function sendMessage(message) {
        ...
        if (!config.webhook || !config.webhook.url) {
            addErrorMessage('تم تكوين عنصر الدردشة بدون رابط خادم صالح. يرجى إضافة رابط الـ Webhook.');
            return;
        }
        ...
        // n8n chatbot template expects an array of items in the request body.[web:6][web:22]
        ...
        .then(function(data) {
            ...
            if (typeof data === 'string') {
                ...
                const textValue = allValues.find(function(val) { 
                    return typeof val === 'string' && val.length > 10 && !val.includes('sessionid'); 
                });
